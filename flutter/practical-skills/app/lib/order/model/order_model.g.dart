...
OrderProductModel _$OrderProductModelFromJson(Map<String, dynamic> json) => OrderProductModel(
...
Map<String, dynamic> _$OrderProductModelToJson(OrderProductModel instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
...
OrderModel _$OrderModelFromJson(Map<String, dynamic> json) => OrderModel(
      ...
      products: (json['products'] as List<dynamic>)
          .map(
            (e) => OrderProductAndCountModel.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
