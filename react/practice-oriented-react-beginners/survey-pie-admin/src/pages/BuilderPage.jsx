...
const BuilderPage = () => {
  ...
  const handleInputChanged = (e) => {
    setData((previous) => ({ ...previous, title: e.target.value }));
  };
  ...
  const handleUpButtonClicked = (index) => {
    if (index === 0) return;
  ...
  const handleDownButtonClicked = (index) => {
      ...
      <Row>
        <Col flex='auto'>
          ...
          <PreviewSection
            ...
            onUpButtonClicked={handleUpButtonClicked}
            onDownButtonClicked={handleDownButtonClicked}
